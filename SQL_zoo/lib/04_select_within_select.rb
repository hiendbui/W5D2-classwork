...
def population_constraint
  ...
  # more than Canada but less than
...
def sparse_continents
  ...
  # continent where each country's
  # population is less than 25,000,000. 
  # Show name, continent and
  # population.
  # Hint: Sometimes rewording the problem 
  # can help you see the solution.

  # select only the continents that only 
  # have populations that are less than 25 mil
  execute(<<-SQL)
    SELECT
